...
<html lang="en">
<head>
    <title>PPDB SMK PGRI 1 BALARAJA</title>
    <meta charset="utf-8">
    ...
    <link rel="stylesheet" href="<?= base_url('asset_landing/css/owl.carousel.min.css');?>">
    <link rel="stylesheet" href="<?= base_url('asset_landing/css/owl.theme.default.min.css');?>">
    <link rel="stylesheet" href="<?= base_url('asset_landing/css/magnific-popup.css');?>">

    <link rel="stylesheet" href="<?= base_url('asset_landing/css/bootstrap-datepicker.css');?>">
    <link rel="stylesheet" href="<?= base_url('asset_landing/css/jquery.timepicker.css');?>">

    
    <link rel="stylesheet" href="<?= base_url('asset_landing/css/flaticon.css');?>">
    <link rel="stylesheet" href="<?= base_url('asset_landing/css/style.css');?>">
</head>
<body>
 <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
   <div class="container">
     <a class="navbar-brand" href="#"><span>PPDB</span></a>
...
<div class="hero-wrap js-fullheight" style="background-image: url('<?= base_url("asset_landing/images/image_2.jpg");?>');">
  <div class="overlay"></div>
  <div class="container">
    <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
      <div class="col-md-7 ftco-animate">
        <span class="subheading text-primary" style="-webkit-text-stroke:1px #fff; font-size: 18px;">SELAMAT DATANG</span>
        <h1 class="mb-4 text-primary" style="-webkit-text-stroke:1px #fff;">CALON SISWA BARU</h1>
        <h1 class="mb-4 text-primary" style="-webkit-text-stroke:1px #fff;">SMK PGRI 1 BALARAJA</h1>
        
        <p class="mb-0"><a href="<?= base_url('Login'); ?>" class="btn btn-white">LOGIN</a></p>
    </div>
</div>
</div>
</div>
          ...
          <div class="login-wrap p-4 p-md-5">
            <?= $this->session->flashdata('message'); ?>
              ...
              <form action="" class="signup-form" method="post">
                ...
                <div class="form-group">
                 <label class="label" for="password">Captha</label>
...
<section class="ftco-section bg-light">
   <div class="container">
      <div class="row justify-content-center pb-4">
          <div class="col-md-12 heading-section text-center ftco-animate">
            ...
            <h2 class="mb-4">FASILITAS SEKOLAH</h2>
        </div>
    </div>
    <div class="row">
       <div class="col-md-4 ftco-animate">
          <div class="project-wrap">
             <a  class="img" style="background-image: url(images/work-1.jpg);">
                <span class="price">Software</span>
            </a>
            <div class="text p-4">
                <h3><a >Design for the web with adobe photoshop</a></h3>
   ...
   <div class="col-md-4 ftco-animate">
      <div class="project-wrap">
         <a  class="img" style="background-image: url(images/work-2.jpg);">
            <span class="price">Software</span>
        </a>
        <div class="text p-4">
            <h3><a >Design for the web with adobe photoshop</a></h3>
...
<div class="col-md-4 ftco-animate">
  <div class="project-wrap">
     <a  class="img" style="background-image: url(images/work-3.jpg);">
        <span class="price">Software</span>
    </a>
    <div class="text p-4">
        <h3><a>Design for the web with adobe photoshop</a></h3>
             ...
             <div class="col-md-6 pl-md-5 py-5">
              <div class="row justify-content-start pb-3">
                  <div class="col-md-12 heading-section ftco-animate">
                     ...
                     <p><a  class="btn btn-primary">Get in touch with us</a></p>
                 </div>
             </div>
         </div>
     </div>
 ...
 <div class="row d-flex">
  <div class="col-lg-4 ftco-animate">
    <div class="blog-entry">
      <a href="blog-single.html" class="block-20" style="background-image: url('<?= base_url("asset_landing/images/image_1.jpg");?>');">
      </a>
...
<script src="<?= base_url('asset_landing/js/jquery.min.js');?>"></script>
<script src="<?= base_url('asset_landing/js/jquery-migrate-3.0.1.min.js');?>"></script>
<script src="<?= base_url('asset_landing/js/popper.min.js');?>"></script>
<script src="<?= base_url('asset_landing/js/bootstrap.min.js');?>"></script>
<script src="<?= base_url('asset_landing/js/jquery.easing.1.3.js');?>"></script>
<script src="<?= base_url('asset_landing/js/jquery.waypoints.min.js');?>"></script>
...
<script src="<?= base_url('asset_landing/js/jquery.animateNumber.min.js');?>"></script>
<script src="<?= base_url('asset_landing/js/bootstrap-datepicker.js');?>"></script>
<script src="<?= base_url('asset_landing/js/scrollax.min.js');?>"></script>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
<script src="<?= base_url('asset_landing/js/google-map.js');?>"></script>
<script src="<?= base_url('asset_landing/js/main.js');?>"></script>
