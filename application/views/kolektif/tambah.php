				...
				<div class="page-inner">
					<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="<?= base_url('Kolektif'); ?>"><?= $title; ?></a>
							</li>
							<li class="separator">
								<i class="flaticon-right-arrow"></i>
							</li>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-body">
									 ...
									 <form action="<?= base_url('Kolektif/add'); ?>" method="post">
										...
										<div class="form-group">
											...
											<input type="number" name="cashback" id="cashback" class="form-control" readonly="">
										</div>

										<div class="form-group">
											<label>Nama Kolektor</label>
											<input type="text" name="nama_kolektif" id="nama_kolektor" class="form-control">
										</div>
